...
const Introduction = () => {
  return (
    <div
      id="home"
      className="flex items-center justify-center px-4 sm:px-6 lg:px-8 py-6 bg-white dark:bg-gray-900 transition-colors duration-300"
    >
      <div className="max-w-5xl w-full">
        <div className="flex flex-col md:flex-row items-center gap-8 md:gap-12">
          ...
          <div className="flex-1">
            ...
            {/* Subheading */}
            <h2 className="text-xl sm:text-2xl md:text-3xl text-gray-600 dark:text-gray-300 mb-6 py-4">
              Full Stack Developer & Complex Problem Solver
            </h2>

            {/* Paragraph */}
            <p className="text-base sm:text-lg text-gray-700 dark:text-gray-400 mb-8 leading-relaxed">
            ...
            <div className="flex flex-wrap gap-4">
              <a
                ...
                className="inline-block px-6 py-3 bg-blue-600 dark:bg-blue-500 text-white font-medium rounded-lg hover:bg-blue-700 dark:hover:bg-blue-600 transition-colors text-center"
              >
                Resume
              </a>
              <a
          ...
          <div className="flex-shrink-0">
            <div className="w-56 h-56 md:w-64 md:h-64 rounded-full overflow-hidden border-4 border-blue-600 dark:border-blue-400 shadow-xl dark:shadow-blue-900/30">
              <img
                src={pfp}
